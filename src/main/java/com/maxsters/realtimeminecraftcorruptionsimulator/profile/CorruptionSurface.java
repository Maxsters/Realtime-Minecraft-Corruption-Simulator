...
public enum CorruptionSurface {
    ...
    LAUNCH_DIRECTION(0.82F, 0.46F, 0.28F, 0.34F, CorruptionOperation.DRIFT, CorruptionOperation.OFFSET, CorruptionOperation.DESYNC, CorruptionOperation.STUTTER),
    PROJECTILE_PHYSICS(0.74F, 0.46F, 0.28F, 0.34F, CorruptionOperation.AMPLIFY, CorruptionOperation.DAMPEN, CorruptionOperation.INVERT, CorruptionOperation.OFFSET),
    ...
    BLOCK_BEHAVIOR(0.74F, 0.48F, 0.32F, 0.40F, CorruptionOperation.DESYNC, CorruptionOperation.STUTTER, CorruptionOperation.DAMPEN, CorruptionOperation.REPLACE),
