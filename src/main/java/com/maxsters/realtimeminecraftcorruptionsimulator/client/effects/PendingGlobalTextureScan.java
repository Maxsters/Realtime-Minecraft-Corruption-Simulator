...
@OnlyIn(Dist.CLIENT)
final class PendingGlobalTextureScan {
    ...
    PendingGlobalTextureScan(String signature, CorruptionEffectStack stack, Map<ResourceLocation, Resource> resources, List<ResourceLocation> textureIds, List<ResourceLocation> donorTextureIds, Set<ResourceLocation> staleTextureIds) {
