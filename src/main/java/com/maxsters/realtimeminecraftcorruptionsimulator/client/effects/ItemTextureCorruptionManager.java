...
public final class ItemTextureCorruptionManager {
    ...
    private static final class CorruptedMaterialVertexConsumer implements VertexConsumer {
        ...
        private CorruptedMaterialVertexConsumer(VertexConsumer delegate, long seed, float intensity, boolean extreme) {
            this.delegate = delegate;
            this.seed = seed;
